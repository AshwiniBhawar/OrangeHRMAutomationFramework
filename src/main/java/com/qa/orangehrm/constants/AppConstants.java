...
public class AppConstants {
	...
	public static final List<String> ADMIN_HEADERS_LIST=List.of("User Management", "Job", "Organization", "Qualifications", "Nationalities", "Corporate Branding", "Configuration");
